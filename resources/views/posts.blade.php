        ...
        @if ($posts->count())
            ...
            <div class="card-body text-center">
              ...
              <p>
                ...
                Author. <a href="/posts?author={{ $posts[0]->author->username }}" class="text-decoration-none">{{ $posts[0]->author->name }}</a> in <a href="/posts?kategori={{ $posts[0]->kategori->slug }}" class="text-decoration-none">{{ $posts[0]->kategori->name}}</a> {{ $posts[0]->created_at->diffForHumans() }}
                </small>
                </p>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <div class="position-absolute px-3 py-2" style="background-color: rgba(0, 0, 0, 0.7)"><a href="/posts?kategori={{ $post->kategori->slug }}" class="text-white text-decoration-none">{{ $post->kategori->name }}</a></div>
